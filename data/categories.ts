...
export const CATEGORIES: ToolCategory[] = [
  { id: 'ai', name: 'AI Tools', description: 'Advanced AI powered generation and analysis', icon: '🧠', color: 'bg-indigo-500' },
  ...
  { id: 'education', name: 'Education', description: 'Learning and Academic tools', icon: '🎓', color: 'bg-amber-500' },
];
