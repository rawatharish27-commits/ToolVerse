...
export const TOOLS: Tool[] = [
  ...
  // --- SOCIAL TOOLS (181-200) ---
  { slug: 'youtube-title-generator', title: 'YouTube Title Generator', category: 'ai', priority: 85, description: 'Get viral YouTube titles.', keywords: ['video', 'youtube'], toolType: 'ai' },
  { slug: 'instagram-caption-generator', title: 'IG Caption Generator', category: 'ai', priority: 85, description: 'Generate creative IG captions.', keywords: ['instagram', 'social'], toolType: 'ai' },
  { slug: 'hashtag-generator', title: 'Hashtag Generator', category: 'ai', priority: 82, description: 'Find trending hashtags.', keywords: ['seo', 'viral'], toolType: 'ai' }
];
